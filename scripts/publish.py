...
SHOWS = {
    ...
    "lifehack": {
        ...
        "cover": "lifehack-cover-v2.png",
        "hour": 7,
        "channel_title": "kota テックラジオ",
        "channel_desc": "毎日1本、AI・ツール・ガジェット・Webサービスなど、いま役立つテックの新サービスや実践的な活用法を1つ、すぐ試せる形で深掘り解説する、kota専用の音声番組。",
        "category": "Technology",
