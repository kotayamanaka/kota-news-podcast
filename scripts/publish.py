...
SHOWS = {
    ...
    "chishiki": {
        ...
        "hour": 7,
        "channel_title": "kota 知識ラジオ",
        "channel_desc": "毎日1本、企業・商品・日本の駅と周辺地域・世界の国・経営者・業界特集をローテーションで深掘りする、kota専用の教養音声番組。",
        "category": "Education",
        "default_title": "知識ラジオ（{date}）",
    },
    "kanshou": {
        ...
        "hour": 8,
        "channel_title": "kota 鑑賞ふりかえりラジオ",
        "channel_desc": "毎日1本、kota がNotionに記録した鑑賞作品（本・映画・ドラマ・音楽ほか）を1つ取り上げ、背景や見どころを語れるレベルまで深掘りする、kota専用の音声番組。",
        "category": "Arts",
        "default_title": "鑑賞ふりかえり（{date}）",
    },
    "fukushi": {
